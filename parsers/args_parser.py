...
class ArgParser(object):
    ...
    def get_args():
        ...
        parser_iperf.add_argument('server', metavar='server', help='local or username@hostname')
        parser_iperf.add_argument('client', metavar='client', help='username@hostname or local')
